...
class Aria2Connection implements aria2_methods.Aria2Methods {
  ...
  Future _requestApi(String method, List params) async {
    ...
    if (protocol == 'websocket') {
      ...
      var res = await Dio().post(rpcUrl, data: {'jsonrpc': '2.0', 'id': 'flutter', "method": method, "params": params});
      // return res.data;
  ...
  Future<String> requestApi(String method, List<String> url, Map<String, dynamic> params) async {
    return await _requestApi(method, [url, params]);
  }
  ...
  @override
  Future<List<int>> changeUri(String gid, int fileIndex, List<String> delUris, List<String> addUris) async {
    return await _requestApi('aria2.changeUri', [gid, fileIndex, delUris, addUris]);
  }
