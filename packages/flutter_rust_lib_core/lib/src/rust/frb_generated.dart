...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1617151877;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<Manager> crateApiSystemClipboardClipboardManagerNew(
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<Manager> crateApiSystemClipboardClipboardManagerNew(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSystemClipboardClipboardManagerNewConstMeta,
      argValues: [sender],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSystemClipboardClipboardManagerNewConstMeta =>
      const TaskConstMeta(
