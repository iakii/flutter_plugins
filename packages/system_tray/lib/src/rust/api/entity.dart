...
class FFIPhysicalPosition {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FFIPhysicalPosition && runtimeType == other.runtimeType && x == other.x && y == other.y;
}
...
class FFIPhysicalSize {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FFIPhysicalSize && runtimeType == other.runtimeType && width == other.width && height == other.height;
}
...
class FFIRect {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FFIRect && runtimeType == other.runtimeType && size == other.size && position == other.position;
}
...
class FFISysTrayEvent {
  ...
  static Future<FFISysTrayEvent> fromEvent({required MySysTrayEventEnum eventType, String? menuEventId, FFIIconEvent? trayEvent}) => RustLib.instance.api.crateApiEntityFfiSysTrayEventFromEvent(eventType: eventType, menuEventId: menuEventId, trayEvent: trayEvent);

  @override
  int get hashCode => eventType.hashCode ^ menuEventId.hashCode ^ trayEvent.hashCode;

  @override
  bool operator ==(Object other) => identical(this, other) || other is FFISysTrayEvent && runtimeType == other.runtimeType && eventType == other.eventType && menuEventId == other.menuEventId && trayEvent == other.trayEvent;
}
