...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  Future<void> executeRustInitializers() async {
    await api.crateApiSysTrayInitApp();
  }
  ...
  @override
  int get rustContentHash => -1787060630;
...
abstract class RustLibApi extends BaseApi {
  Future<FFISysTrayEvent> crateApiEntityFfiSysTrayEventFromEvent(
      {required MySysTrayEventEnum eventType,
      String? menuEventId,
      FFIIconEvent? trayEvent});

  Stream<FFISysTrayEvent> crateApiSysTrayBuilder({required String path});

  String crateApiSysTrayGreet({required String name});

  Future<void> crateApiSysTrayInitApp();
}
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<FFISysTrayEvent> crateApiEntityFfiSysTrayEventFromEvent(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiEntityFfiSysTrayEventFromEventConstMeta,
      argValues: [eventType, menuEventId, trayEvent],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiEntityFfiSysTrayEventFromEventConstMeta =>
      const TaskConstMeta(
  ...
  @override
  Stream<FFISysTrayEvent> crateApiSysTrayBuilder({required String path}) {
    final sink = RustStreamSink<FFISysTrayEvent>();
    unawaited(handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_String(path, serializer);
        sse_encode_StreamSink_ffi_sys_tray_event_Sse(sink, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
            funcId: 2, port: port_);
      },
      codec: SseCodec(
      ...
      constMeta: kCrateApiSysTrayBuilderConstMeta,
      argValues: [path, sink],
      apiImpl: this,
    )));
    return sink.stream;
  ...
  TaskConstMeta get kCrateApiSysTrayBuilderConstMeta => const TaskConstMeta(
        debugName: "builder",
        argNames: ["path", "sink"],
      );
  ...
  String crateApiSysTrayGreet({required String name}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiSysTrayGreetConstMeta,
      argValues: [name],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSysTrayGreetConstMeta => const TaskConstMeta(
        debugName: "greet",
        argNames: ["name"],
      );
  ...
  Future<void> crateApiSysTrayInitApp() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSysTrayInitAppConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSysTrayInitAppConstMeta => const TaskConstMeta(
        debugName: "init_app",
        argNames: [],
      );
