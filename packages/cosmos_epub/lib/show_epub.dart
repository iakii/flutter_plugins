...
List<String> fontNames = ["Segoe", "Alegreya", "Amazon Ember", "Atkinson Hyperlegible", "Bitter Pro", "Bookerly", "Droid Sans", "EB Garamond", "Gentium Book Plus", "Halant", "IBM Plex Sans", "LinLibertine", "Literata", "Lora", "Ubuntu"];

Color backColor = Colors.white;
Color fontColor = Colors.black;
int staticThemeId = 3;

extension _num on num {
                                    ...
                                    children: [
                                            ...
                                            child: DropdownButton<String>(
                                                ...
                                                items: fontNames.map<DropdownMenuItem<String>>((String font) {
                                                  return DropdownMenuItem<String>(
                                                    ...
                                                    child: Text(
                                                      font,
                                                      style: TextStyle(color: selectedFont == font ? widget.accentColor : fontColor, package: 'cosmos_epub', fontSize: context.isTablet ? 10.sp : 15.sp, fontWeight: selectedFont == font ? FontWeight.bold : FontWeight.normal, fontFamily: font),
                                                    ),
                                                  );
                                                }).toList()),
                                          ),
                                      ...
                                      Row(
                                        children: [
                                          Text(
                                            "Aa",
                                            style: TextStyle(fontSize: 15.sp, color: fontColor, fontWeight: FontWeight.bold),
                                          ),
                                          Expanded(
                                            child: Slider(
                                              activeColor: staticThemeId == 4 ? Colors.grey.withOpacity(0.8) : Colors.blue,
                                          ...
                                          Text(
                                            "Aa",
                                            style: TextStyle(color: fontColor, fontSize: 20.sp, fontWeight: FontWeight.bold),
                                          )
                                        ],
                                      )
                                    ],
                                      ...
                                      child: RotatedBox(
                                          ...
                                          child: SliderTheme(
                                              data: SliderThemeData(
                                                ...
                                                thumbColor: staticThemeId == 4 ? Colors.grey.withOpacity(0.8) : Colors.blue,
                                                thumbShape: RoundSliderThumbShape(enabledThumbRadius: 0.r),
                                                // Adjust the size of the thumb
                                                overlayShape: RoundSliderOverlayShape(overlayRadius: 10.r), // Adjust the size of the overlay
                                              ),
                                              child: Slider(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              flex: 10,
                              child: Text(
                                chaptersList.isNotEmpty ? chaptersList[bookProgress.getBookProgress(bookId).currentChapterIndex ?? 0].chapter : 'Loading...',
                                maxLines: 1,
