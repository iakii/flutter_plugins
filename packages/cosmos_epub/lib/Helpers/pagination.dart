...
import 'package:cosmos_epub/Helpers/html.dart';
  ...
  Future<void> _paginate() async {
    ...
    await Future.wait(lines.map((line) async {
      ...
      if (currentPageBottom < bottom) {
        currentPageEndIndex = textPainter.getPositionForOffset(Offset(left, top - (innerHtml != null ? 0 : 100))).offset;
        ...
        currentPageBottom = top + pageSize.height - (innerHtml != null ? 120 : 150);
      }
    }));
        ...
        child: Container(
          ...
          child: FadingEdgeScrollView.fromSingleChildScrollView(
            ...
            child: SingleChildScrollView(
              ...
              child: Padding(
                padding: const EdgeInsets.only(bottom: 40, top: 60, left: 10, right: 10),
                child: widget.innerHtmlContent != null
                    ? HtmlWidget(
                        customWidgetBuilder: (element) => customWidgetBuilder(widget.book, element, widget.style),
                        widget.innerHtmlContent!,
