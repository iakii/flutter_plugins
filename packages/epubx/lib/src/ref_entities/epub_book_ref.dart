...
class EpubBookRef {
  ...
  bool operator ==(other) {
    ...
    return Title == other.Title && Author == other.Author && Schema == other.Schema && Content == other.Content && collections.listsEqual(AuthorList, other.AuthorList);
  }
  ...
  Future<Image?> readCover() async {
    return await BookCoverReader.readBookCover(this).catchError((e) {
      return null;
    });
  }
}
